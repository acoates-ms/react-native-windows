...
#include "RNSVG.RenderableView.g.h"
#include "RNSVG.SvgNodeCommonProps.g.h"
#include "RNSVG.SvgRenderableCommonProps.g.h"
#include "RNSVG.D2DDeviceContext.h"
#include "RNSVG.D2DGeometry.h"
...
struct RenderableView : RenderableViewT<RenderableView> {
 public:
  ...
  Numerics::float3x2 SvgTransform() {
  ...
  hstring FillBrushId() {
    return m_fillBrushId;
  }
  winrt::Microsoft::ReactNative::Color Fill() {
    return m_fill;
  }
  float FillOpacity() {
    return m_fillOpacity;
  }
  hstring StrokeBrushId() {
    return m_strokeBrushId;
  }
  winrt::Microsoft::ReactNative::Color Stroke() {
    return m_stroke;
  }
  float StrokeOpacity() {
  ...
  RNSVG::SVGLength StrokeWidth() {
    return m_strokeWidth;
  }
  Windows::Foundation::Collections::IVector<RNSVG::SVGLength> StrokeDashArray() {
    return m_strokeDashArray;
  }
  RNSVG::LineCap StrokeLineCap() {
    return m_strokeLineCap;
  }
  RNSVG::LineJoin StrokeLineJoin() {
