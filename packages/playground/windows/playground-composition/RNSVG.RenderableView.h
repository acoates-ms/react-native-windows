...
struct RenderableView : RenderableViewT<RenderableView> {
 public:
  ...
  void SvgParent(winrt::Microsoft::ReactNative::ComponentView const &value) { m_parent = value; }
 ...
 private:
  ...
  winrt::Windows::UI::Color m_fill { Windows::UI::Color{255,0,0,0} };
  winrt::Windows::UI::Color m_stroke { Windows::UI::Color{0,0,0,0} };
